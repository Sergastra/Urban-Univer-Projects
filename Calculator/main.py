...
button_add = tk.Button(window, text="+", width=3, height=1, command=add)
button_add.place(x=100, y=200)
button_add = tk.Button(window, text="-", width=3, height=1, command=sub)
button_add.place(x=150, y=200)
button_mul = tk.Button(window, text="*", width=3, height=1, command=mul)
button_mul.place(x=200, y=200)
button_div = tk.Button(window, text="/", width=3, height=1, command=div)
